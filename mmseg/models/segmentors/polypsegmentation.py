...
class PolypSegmentation(nn.Module):
    def __init__(
        ...
        self.ra0_conv1 = Conv(self.in_channels[0], 64, 3, 1, padding=1, bn_acti=True)
        self.ra0_conv2 = Conv(64, 32, 3, 1, padding=1, bn_acti=True)
        self.ra0_conv3 = Conv(32, 1, 3, 1, padding=1, bn_acti=True)

        self.ra1_conv1 = Conv(self.in_channels[1], 64, 3, 1, padding=1, bn_acti=True)
        self.ra1_conv2 = Conv(64, 32, 3, 1, padding=1, bn_acti=True)
        self.ra1_conv3 = Conv(32, 1, 3, 1, padding=1, bn_acti=True)

        self.ra2_conv1 = Conv(self.in_channels[2], 64, 3, 1, padding=1, bn_acti=True)
        self.ra2_conv2 = Conv(64, 32, 3, 1, padding=1, bn_acti=True)
        self.ra2_conv3 = Conv(32, 1, 3, 1, padding=1, bn_acti=True)

        self.ra3_conv1 = Conv(self.in_channels[3], 64, 3, 1, padding=1, bn_acti=True)
        self.ra3_conv2 = Conv(64, 32, 3, 1, padding=1, bn_acti=True)
        self.ra3_conv3 = Conv(32, 1, 3, 1, padding=1, bn_acti=True)

        self.aa_kernel_0 = Modified_ECA(self.in_channels[0])
        self.aa_kernel_1 = Modified_ECA(self.in_channels[1])
        self.aa_kernel_2 = Modified_ECA(self.in_channels[2])
        self.aa_kernel_3 = Modified_ECA(self.in_channels[3])
